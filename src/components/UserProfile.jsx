        ...
        <div className="pt-[9.1rem] pb-[2rem]">
            ...
            <div className="w-full md:p-6 xs:p-4 rounded-lg md:mt-0 sm:p-8 bg-primary-white">
                <div className="w-full mx-auto shadow-xl rounded-sm border border-gray-200 dark:border dark:border-gray-800">
                    <h1 className="text-2xl font-semibold p-4 bg-primary-light-brown shadow-lg dark:bg-primary-light-brown dark:text-white rounded-sm">Profile</h1>
                    ...
                    <div className="w-full md:flex sm:gap-2 xs:gap-0">
                        ...
                        <div className="flex-1 bg-primary-white">
                            ...
                            {currentStep === 1 && (
                                <div className="md:w-[88%] xs:w-[92%] px-4 py-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        {/* Alternative Number */}
                                        <div className="w-full mb-4">
                                            <label htmlFor="alt_phone" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alternative Number</label>
                                            <input
                                                type="text"
                                                name="alt_phone"
                                                id="alt_phone"
                            ...
                            {currentStep === 3 && (
                                <div className="md:w-[88%] xs:w-[92%] px-4 py-6">
                                    <div className="flex items-center  mb-4">
                                        <p className="text-lg text-gray-700 mr-3">Havent found your pets yet...  </p>
                                        <a href="LostPetForm" className="inline-block rounded text-lg bg-primary-light-brown border-[#d2c8bc] py-2 px-4 font-medium text-primary-brown shadow hover:bg-primary-brown hover:border-[#866552] hover:text-white focus:outline-none focus:ring transition duration-200">
                                            Add Lost Pet
                                        </a>
                                    </div>
                                    <div className="grid grid-cols-1 gap-4 mt-8">
                            ...
                            {currentStep === 4 && (
                                <div className="md:w-[88%] xs:w-[92%] px-4 py-6">
                                    <div className="flex items-center  mb-4">
                                        <p className="text-lg text-gray-700 mr-3">Help others with your stories...  </p>
                                        <a href="/add-adoption" className="inline-block rounded text-lg bg-primary-light-brown border-[#d2c8bc] py-2 px-4 font-medium text-primary-brown shadow hover:bg-primary-brown hover:border-[#866552] hover:text-white focus:outline-none focus:ring transition duration-200">
                                            Add SuccessStories
                                        </a>
                                    </div>
